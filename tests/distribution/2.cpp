...
int main(int,char**) {
  std::cout
  << " e1: " << hash(xmsm::type_c<entity_1>)
  << " e2: " << hash(xmsm::type_c<entity_2>)
  << "\n0: " << hash(xmsm::type_c<state<0>>)
  << " 1: " << hash(xmsm::type_c<state<1>>)
  << " 2: " << hash(xmsm::type_c<state<2>>)
  << " 3: " << hash(xmsm::type_c<state<3>>)
  << " 100: " << hash(xmsm::type_c<state<100>>)
  << " 111: " << hash(xmsm::type_c<state<111>>)
  << "\n" << std::endl;
}
